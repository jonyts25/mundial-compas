/**
 * CLI — push quiniela por rondas + partido de hoy (dedupe metadata.announcement_key).
 */
...
async function main() {
  ...
  const announcementKey = KNOCKOUT_ROUND_QUINIELA_VERSION;
  ...
  const payload = {
    title: KNOCKOUT_ROUND_QUINIELA_ANNOUNCEMENT.title,
    body: KNOCKOUT_ROUND_QUINIELA_ANNOUNCEMENT.description,
    url: "/quiniela",
    tag: announcementKey,
  };
