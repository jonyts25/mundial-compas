/**
 * CLI — push reglas eliminatoria (dedupe metadata.announcement_key).
 */
import { createClient } from "@supabase/supabase-js";
import webpush from "web-push";
import { loadEnvLocal } from "./load-env-local.mjs";
import { KNOCKOUT_RULES_ANNOUNCEMENT, KNOCKOUT_RULES_VERSION } from "@/lib/product/whats-new";
...
async function main() {
  ...
  const announcementKey = KNOCKOUT_RULES_VERSION;
  ...
  const payload = {
    title: KNOCKOUT_RULES_ANNOUNCEMENT.title,
    body: KNOCKOUT_RULES_ANNOUNCEMENT.description,
    url: "/quiniela",
    tag: announcementKey,
  };
